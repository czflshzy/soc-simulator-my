...
void func_run(Vmycpu_top *top, axi4_ref <32,32,4> &mmio_ref) {
    ...
    mmio_mem perf_mem(262144*4, "../../func_test_v0.01/soft/func/obj/main.bin");
    ...
    confreg.set_trace_file("../../func_test_v0.01/cpu132_gettrace/golden_trace.txt");
...
void perf_run(Vmycpu_top *top, axi4_ref <32,32,4> &mmio_ref, int test_start = 1, int test_end = 10) {
    ...
    mmio_mem perf_mem(262144*4, "../../perf_test_v0.01/soft/perf_func/obj/allbench/inst_data.bin");
    assert(mmio.add_dev(0x1fc00000,0x100000,&perf_mem));
...
void cemu_perf_diff(Vmycpu_top *top, axi4_ref <32,32,4> &mmio_ref, int test_start = 1, int test_end = 10) {
    ...
    mmio_mem cemu_func_mem(262144*4, "../../perf_test_v0.01/soft/perf_func/obj/allbench/inst_data.bin");
